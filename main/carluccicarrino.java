...
public class carluccicarrino {
    ...
    public static void main(String[] args) {
        ...
        File loadFile = new File("..\\carluccicarrino\\src\\IO\\esempio-formato-dati.txt");
        File saveFile = new File("..\\carluccicarrino\\src\\IO\\savefile.txt");
        ...
        Person actorColl = Core.getPersonByName("Al Pacino");
        if(actorColl != null){
